...
<!-- 3. SPLIT SECTION (BÊN TRÁI: CONTENT/BIO - BÊN PHẢI: ẢNH GIGACHAD ASTARTES) -->
<!-- 3. SPLIT SECTION: KHÔNG KHUNG VIỀN + ẢNH CHIỀU CAO BẰNG VỚI CONTENT -->
<table style="border: 0; border-collapse: collapse;">
  <tr style="border: 0;">
    <td width="65%" valign="top" style="border: 0; padding-right: 15px;">
      <p>
        <img src="https://komarev.com/ghpvc/?username=TuanpvGCD210193&label=PROFILE%20VIEWS&color=b8860b&style=flat-square" alt="Views" />
      </p>
      <ul>
        <li>⚙️ <b>Core Doctrines:</b> Gameplay Systems, Character Locomotion, Hitbox Physics & Combat Mechanics.</li>
        <li>⚡ <b>Sacred Engines:</b> Unreal Engine 5 (High-Performance C++) • Unity (C# Architecture).</li>
        <li>🛠️ <b>Current Rite:</b> Polishing gameplay prototypes, combat systems & dynamic AI behaviors.</li>
        <li>💬 <b>Invocations:</b> C#, C++, Vector Math, Physics Simulation, SOLID & Game Architecture.</li>
        <li>📬 <b>Imperial Vox Link:</b> <a href="mailto:phamtuanvan264@gmail.com">phamtuanvan264@gmail.com</a></li>
      </ul>
    </td>
    <td width="35%" align="center" valign="middle" style="border: 0;">
      <img src="https://github.com/user-attachments/assets/e2882530-f35e-4712-958b-12d696de5051" height="3500px" alt="Gigachad Astartes" />
    </td>
  </tr>
</table>
